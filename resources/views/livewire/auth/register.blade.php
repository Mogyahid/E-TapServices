...
<div class="bg-red-600">
    ...
    <!-- style="background-image: url('logo/Logo.png'); background-repeat: no-repeat; background-size: cover" -->
        ...
        <div class="flex h-screen w-screen justify-center items-center">
            <div class="h-5/5 w-4/5 bg-white shadow-md">
                ...
                <div class="p-7 flex-1">
                    ...
                    <div class="mt-5 flex items-center justify-between">
                        ...
                        <button wire:click="register()" class="uppercase px-10 py-3 rounded-full bg-gradient-to-r from-blue-600 to-blue-500 hover:shadow-md items-center bg-blue-500 text-white flex w-46 space-x-2 mb-3 float-right">
                            <span>Register</span>
