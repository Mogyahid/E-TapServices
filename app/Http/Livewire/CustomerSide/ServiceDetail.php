...
class ServiceDetail extends Component
{
    ...
    public $req;
    public $province_value, $city_value, $brgy_value, $province, $city, $barangay, $street;
    public $cities = [];
    public $barangays = [];
    public $offerImages, $offerId;
    ...
    public function render()
    {
        ...
        $this->offerImages = ServiceOffer::where('id', $this->service_id)->get();
    ...
    {
        foreach($this->offerImages as $offer_id){
            $this->offerId = $offer_id->provider_id;
            dd($this->offerId);
        }
        ...
        if(!empty($this->province)){
            $this->address = $this->street . ", ". $this->brgy_value . ", ".$this->city_value .", ".$this->province_value;
            $this->req = ClientRequestService::create([
                'transaction_code' => $this->transaction_code,
                'category_id' => session()->pull("cat_id"),
                'customer_id' => Auth::id(),
                'serviceOffer_id' => $this->service_id,
                'provider_id' => $this->offerId,
